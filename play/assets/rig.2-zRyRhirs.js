const r=`<!-- Köfte 2★: more meat. TIERS.md rule: the body grows and the growth reads from the top. The ball rose y 41 → 33 (78 tall), the furrows rose with it, and a small second ball sits on top as the crown (y 21). Arms, fists, legs and boots are the 1★ parts unchanged; \`cooked\` grew with the silhouette. Palette and face as 1★ (style bible, ticket 16). -->\r
<svg xmlns="http://www.w3.org/2000/svg" viewBox="-26 -22 212 194"\r
     class="rig" data-atk="punch" data-unit="kofte" data-tier="2" style="--dur-atk:0.90s">\r
\r
...
\r
  <g class="body">\r
    <ellipse cx="52" cy="30" rx="15" ry="9" fill="#8D4A32" stroke="#2A2114" stroke-width="3"/>\r
    <path d="M43 29 Q52 32 61 29" fill="none" stroke="#5E2C1E" stroke-width="4" stroke-linecap="round"/>\r
    <ellipse cx="52" cy="72" rx="34" ry="39" fill="#8D4A32" stroke="#2A2114" stroke-width="4"/>\r
    <path d="M86 72 C86 93 71 111 52 111 L52 105 C67 105 80 91 80 72 Z" fill="#5E2C1E"/>\r
    <path d="M24 66 Q25 58 29 53" fill="none" stroke="#B06A52" stroke-width="5" stroke-linecap="round"/>\r
    <path d="M38 40 Q52 44 66 40 M30 49 Q52 53 74 49 M30 58 Q52 62 74 58"\r
...
\r
    <g class="cooked" style="transform-origin:52px 72px">\r
      <path d="M43 29 Q52 32 61 29 M38 40 Q52 44 66 40 M30 49 Q52 53 74 49 M30 58 Q52 62 74 58"\r
            fill="none" stroke="#2A2114" stroke-width="4.5" stroke-linecap="round"/>\r
      <path d="M23 62 C20 72 20 88 25 98 M81 62 C84 72 84 88 79 98"\r
            fill="none" stroke="#5E2C1E" stroke-width="5" stroke-linecap="round"/>\r
      <circle cx="30" cy="49" r="2.6" fill="#E4632A"/>\r
      <circle cx="74" cy="58" r="2.4" fill="#E4632A"/>\r
    </g>\r
\r
...
\r
    <path class="crack" d="M34 46 L46 70 L36 86 L48 100 L38 108"\r
