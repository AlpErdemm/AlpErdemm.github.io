const t=`<!-- Börek 3★ — fırından yeni çıktı. Ölçü 2★ ile birebir; evre: kesik yüzden tek buhar kıvrımı + kubbede kavrulma. -->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="-26 -22 212 194"
  ...
  <ellipse class="shadow" cx="52" cy="137" rx="32" ry="6.2" fill="#000" opacity=".35"/>
  ...
  <g class="body" style="transform-origin:52px 120px">
    <path d="M22 45 Q22 39 28 38 L76 38 Q82 39 82 45 L82 106
             Q80 115 72 116 L31 116 Q22 114 22 106 Z"
          fill="#C98A3C" stroke="#2A2620" stroke-width="4" stroke-linejoin="round"/>
    <path d="M26 46 L78 46" stroke="#EFDCB4" stroke-width="2.4" opacity=".75"/>
    <path d="M64 42 L82 42 L82 112 L64 112 Z" fill="#A96E2A" opacity=".55"/>
    <path d="M22 52 L82 52 M22 66 L82 66 M22 80 L82 80" stroke="#F3E3C0" stroke-width="5"/>
    <path d="M22 52 L82 52 M22 66 L82 66 M22 80 L82 80" stroke="#2A2620" stroke-width="1.4" opacity=".45"/>
    ...
    <path d="M24 47 Q34 42 44 47 T64 47 T81 45 M24 61 Q34 56 44 61 T64 61 T81 59 M24 74 Q34 69 45 74 T65 74 T81 72"
    ...
    <path d="M24 36 Q52 24 80 36 L82 42 L22 42 Z"
          fill="#E3A650" stroke="#2A2620" stroke-width="3.4" stroke-linejoin="round"/>
    <path d="M32 33 Q52 27 72 33" stroke="#F7DFA6" stroke-width="3" fill="none"
          stroke-linecap="round" opacity=".8"/>
    <circle cx="36" cy="35" r="1.6" fill="#2A2620"/>
    <circle cx="52" cy="30" r="1.6" fill="#2A2620"/>
    <circle cx="68" cy="35" r="1.6" fill="#2A2620"/>
    <path d="M27 32 Q21 26 26 20 Q30 15 26 11" fill="none" stroke="#EFE6D2" stroke-width="2.6"
          stroke-linecap="round" opacity=".8"/>
    <path d="M28 33 Q52 23 76 33 Q52 29 28 33 Z" fill="#A96E2A" opacity=".55"/>

    <path d="M31 84 L43 88 M61 88 L73 84" stroke="#2A2620" stroke-width="3.4"
    ...
    <circle cx="36" cy="91.4" r="2.1" fill="#fff"/>
    <circle cx="66" cy="91.4" r="2.1" fill="#fff"/>
    <path d="M44 104 Q52 110 60 104" stroke="#2A2620" stroke-width="3"
