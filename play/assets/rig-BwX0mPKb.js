const r=`<!-- Börek (Strudel) · Dough 5 · Brawler · melee, bare fists\r
     attackSpeed 1.05 → round(20/1.05) = 19 ticks = 0.95 s\r
\r
     Class rule (V3, README "Silahsız gövdeler"): a Brawler carries no weapon,\r
     the hands are the weapon. Both fists wear a wrap torn from the unit's own\r
     material. Archetype \`punch\`: both arms strike, the rear one crossing at 58%.\r
     The front fist's leading edge rests at x 120 (\`WEAPON\` borek [119, 87]).\r
\r
     Redrawn for ticket 15 against docs/style-bible.md. Mass = the slice,\r
     Dough's one rectangle: x 22..82 (60 wide), y 44..116 (72 tall), ratio\r
     1.20, with the browned top crust as the crown (y 36). Two laminations\r
     above the brows and the cut face below carry the "layers" read; the red\r
     sash moved from mid-body to the hem because the cast's eye band sits\r
     where it used to be. Eye y 84 = 56% of the mass. Materials 3 / fills 6:\r
     crust C98A3C A96E2A F3E3C0 · cloth B83A2E · leather 6E4A2A 4A3826 (the\r
     Dough batch's shared leather; its light value is not needed here). The\r
     shade is the right face of the slice, solid; one gleam (F3E3C0) on the crust top. Tint lines, none: the\r
     laminations are 5-wide bands of the crust light, not lines, and the fist\r
     wraps are cloth strips of the same value. -->\r
...
\r
  <g class="body">\r
    ...
    <path d="M22 50 Q22 44 28 44 L76 44 Q82 44 82 50 L82 108 Q82 116 74 116 L30 116 Q22 116 22 108 Z"\r
          fill="#C98A3C" stroke="#2A2114" stroke-width="4" stroke-linejoin="round"/>\r
    <path d="M76 46 L82 50 L82 108 Q82 116 74 116 L74 110 Q77 110 77 106 L77 46 Z" fill="#A96E2A"/>\r
    <path d="M24 54 L80 54 M24 62 L80 62" stroke="#F3E3C0" stroke-width="5"/>\r
    <path d="M24 44 Q52 34 80 44 L82 50 L22 50 Z"\r
          fill="#A96E2A" stroke="#2A2114" stroke-width="3" stroke-linejoin="round"/>\r
    <path d="M30 42 Q40 38.5 50 38.5" fill="none" stroke="#F3E3C0" stroke-width="4" stroke-linecap="round"/>\r
\r
...
\r
    <path class="crack" d="M34 54 L46 70 L36 86 L48 100 L38 112"\r
