const r=`<!-- Pastırma (Pastrami) 3★. Rule: TIERS.md, the material's next stage, no\r
     growth. Hung to dry: the fenugreek crust has split into a dry map-crack\r
     (three tint lines in the crust shade, the rig's only ones) and one loop of\r
     the butcher's twine that hung it swings free from the top-right corner.\r
     Everything else is the 2★ file exactly. -->\r
...
\r
  <g class="body">\r
    ...
    <path d="M26 36 L78 36 Q84 36 84 42 L84 110 Q84 116 78 116 L26 116 Q20 116 20 110 L20 42 Q20 36 26 36 Z"\r
          fill="#8E1F2A" stroke="#2A2114" stroke-width="4" stroke-linejoin="round"/>\r
    <path d="M76 54 L82 54 L82 104 L76 104 Z" fill="#5E1219"/>\r
    <path d="M34 58 Q33 63 34 67" fill="none" stroke="#B8474A" stroke-width="5" stroke-linecap="round"/>\r
    <path d="M26 36 L78 36 Q84 36 84 42 L84 54 L20 54 L20 42 Q20 36 26 36 Z"\r
          fill="#C08A2E" stroke="#2A2114" stroke-width="3" stroke-linejoin="round"/>\r
    <path d="M20 103 L84 103 L84 110 Q84 116 78 116 L26 116 Q20 116 20 110 Z"\r
          fill="#C08A2E" stroke="#2A2114" stroke-width="3" stroke-linejoin="round"/>\r
    <path d="M20 54 L28 54 L28 103 L20 103 Z"\r
          fill="#C08A2E" stroke="#2A2114" stroke-width="3" stroke-linejoin="round"/>\r
    <path d="M76 37.5 L82.5 37.5 L82.5 52.5 L76 52.5 Z M76 104.5 L82.5 105.5 L82.5 114.5 L76 114.5 Z"\r
          fill="#8A6224"/>\r
\r
    <!-- 3★: the dry crust's map-crack, three tint lines; the twine loop that hung\r
         the slice, one leather-light cord over ink, inside x 124. -->\r
    <path d="M30 40 L36 46 L32 51 M48 38 L52 45 L58 42 M64 40 L68 47 L74 44"\r
          fill="none" stroke="#8A6224" stroke-width="2.2" stroke-linejoin="round"/>\r
    <path d="M77 38 Q90 40 88 50 Q86 58 78 56" fill="none" stroke="#2A2114" stroke-width="6.5" stroke-linecap="round"/>\r
    <path d="M77 38 Q90 40 88 50 Q86 58 78 56" fill="none" stroke="#C9A66B" stroke-width="2.5" stroke-linecap="round"/>\r
    <circle cx="77" cy="38" r="3" fill="#C9A66B" stroke="#2A2114" stroke-width="2.3"/>\r
\r
...
\r
    <path class="crack" d="M34 46 L46 66 L36 86 L48 100 L38 110"\r
