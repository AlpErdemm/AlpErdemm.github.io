const t=`<!-- Börek 2★: one more layer. TIERS.md rule: the body grows and the growth reads from the top. The slice rose y 44 → 34, a third lamination sits at y 44, and the top crust became a dome (crown at y 22). Arms, fists, legs and boots are the 1★ parts unchanged. Palette and face as 1★ (style bible, ticket 15). -->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="-26 -22 212 194"
     class="rig" data-atk="punch" data-unit="borek" data-tier="2" style="--dur-atk:0.95s">
