const t=`<!-- Börek 3★: fresh from the oven. Same size as 2★; the stage is one steam curl off the dome and nigella seeds on the crust. Arms, fists, legs and boots are the 1★ parts unchanged. -->
<svg xmlns="http://www.w3.org/2000/svg" viewBox="-26 -22 212 194"
     class="rig" data-atk="punch" data-unit="borek" data-tier="3" style="--dur-atk:0.95s">
  ...
  <g class="body">
    ...
    <path d="M22 40 Q22 34 28 34 L76 34 Q82 34 82 40 L82 108 Q82 116 74 116 L30 116 Q22 116 22 108 Z"
          fill="#C98A3C" stroke="#2A2114" stroke-width="4" stroke-linejoin="round"/>
    <path d="M76 36 L82 40 L82 108 Q82 116 74 116 L74 110 Q77 110 77 106 L77 46 Z" fill="#A96E2A"/>
    <path d="M24 44 L80 44 M24 52 L80 52 M24 60 L80 60" stroke="#F3E3C0" stroke-width="5"/>
    <path d="M24 34 Q52 22 80 34 L82 40 L22 40 Z"
          fill="#A96E2A" stroke="#2A2114" stroke-width="3" stroke-linejoin="round"/>
    <path d="M30 32 Q40 27 50 26.5" fill="none" stroke="#F3E3C0" stroke-width="4" stroke-linecap="round"/>
    <path d="M58 19 Q52 15 57 10" fill="none" stroke="#F3E3C0" stroke-width="2.5" stroke-linecap="round"/>
    <g fill="#2A2114"><ellipse cx="44" cy="28" rx="1.8" ry="1.2"/><ellipse cx="56" cy="26.5" rx="1.8" ry="1.2"/><ellipse cx="66" cy="29.5" rx="1.8" ry="1.2"/></g>
    ...
    <path class="crack" d="M34 44 L46 70 L36 86 L48 100 L38 112"
